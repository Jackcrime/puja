// ─── Jumlah ayat per pasal untuk setiap kitab Alkitab (TB) ───────────────────
// Format: VERSES_PER_CHAPTER[slug][chapterIndex] → jumlah ayat
// Index 0 = Pasal 1, Index 1 = Pasal 2, dst.
...
export const VERSES_PER_CHAPTER: Record<string, number[]> = {
  ...
  nehemia: [11,20,32,23,19,19,73,18,38,39,36,47,31],
  ...
  mazmur: [
    ...
    16, 8,18,12,13,17, 7,18,52,17,16,15, 5,23,11,13,12, 9, 9, 5,
     ...
     8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3,18, 3, 3,21,26, 9, 8,24,
  ...
  pengkhotbah: [18,26,22,16,20,12,29,17,18,20,10,14],
  kidungagung: [17,17,11,16,16,13,13,14],
  yesaya: [
    31,22,26, 6,30,13,25,22,21,34,16, 6,22,32, 9,14,14, 7,25, 6,
    17,25,18,23,12,21,13,29,24,33, 9,20,24,21,29, 2,26,16, 2,25,
    14,29,21,21, 7,10, 8,15,21,21,22,13, 6,13,19, 7,22,21,12,21,
    13,20,22,11,14,17,
  ],
  yeremia: [
     9,20, 4,14,20,10,19,34,22,21,18,12,18,38,35,18,34,23,28, 6,
    17, 5, 6, 7,21,11,24,16,17,31,11, 7,18,25,20,23,13,14, 6,17,
    10,24,22,14, 7, 7,17,20,32,20,28,19,
  ],
  ratapan: [22,22,66,22,22],
  yehezkiel: [
  ...
  obaja:    [21],
  yunus:    [17,10,10,11],
  mikha:    [16,13,12,13,15,16,20],
  nahum:    [15,13,19],
  habakuk:  [17,20,19],
  zefanya:  [18,15,20],
  hagai:    [15,23],
  zakharia: [21,13,10,14,11,15,14,23,17,12,17,14, 9,21],
  maleakhi: [14,17,18, 6],
  ...
  markus: [45,28,35,41,43,56,37,38,50,52,33,44,37,72,47,20],
  lukas: [
  ...
  roma:        [32,29,31,25,21,23,25,39,33,21,36,21,14,23,33,27],
  "1korintus": [31,16,23,21,13,20,40,34,16,30,24,22,33,39,20,28],
  "2korintus": [24,17,18,18,21,18,16,12,20,15,20,10,18],
  galatia:     [24,21,29,31,26,18],
  efesus:      [23,22,21,28,20,32],
  filipi:      [30,30,21,23],
  kolose:      [29,23,25,18],
  "1tesalonika": [10,20,13,18,28],
  "2tesalonika": [12,17,18],
  "1timotius": [20,15,16,16,25,21],
  "2timotius": [18,26,17,22],
  titus:       [16,15,15],
  filemon:     [25],
  ibrani:      [14,18,19,16,14,20,28,13,28,39,40,29,25],
  yakobus:     [27,26,18,17,20],
  "1petrus":   [25,25,22,19,14],
  "2petrus":   [21,22,18],
  "1yohanes":  [10,29,24,21,21],
  "2yohanes":  [13],
  "3yohanes":  [14],
  yudas:       [25],
  wahyu: [
...
/** Ambil jumlah ayat dari pasal tertentu.
 *  @returns jumlah ayat, atau fallback 50 kalau data tidak ditemukan */
export function getVerseCount(bookSlug: string, chapter: number): number {
  return VERSES_PER_CHAPTER[bookSlug]?.[chapter - 1] ?? 50;
}