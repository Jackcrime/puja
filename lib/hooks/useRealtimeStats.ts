...
export function useRealtimeStats(selectedDate?: Date): RealtimeStatsData {
  ...
  const loaded = useRef({ dev: false, maz: false, kot: false, pok: false, khu: false, aut: false });
  ...
  return { devotional, mazmur, khotbah, pokdoa, khusus, authors, loading, lastUpdated };
}